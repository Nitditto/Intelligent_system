...
`RANDOM_SEED = 42`). Each 📸 line names the figures for that section; a few key plots
...
![N5-D — notebook §10: EDA plot grid](report/screenshots/NB_D_02_sec10.png){width=80%}
...
![N8-D — notebook §19: classification report + confusion matrix + ROC](report/screenshots/NB_D_04_sec19.png){width=80%}
...
![N6-H — §10.2: numeric correlation heatmap](report/screenshots/NB_H_07_sec10.2.png){width=80%}
...
![N8-H — notebook §19: predicted-vs-actual + residuals](report/screenshots/NB_H_18_sec19.png){width=80%}
...
![N5-C — notebook §10: EDA plot grid](report/screenshots/NB_C_02_sec10.png){width=80%}
...
![N8-C — notebook §19: classification report + confusion matrix + ROC](report/screenshots/NB_C_03_sec19.png){width=80%}
...
Excluded from the ~10-page body count (assignment §5: *approximately 10 pages, excluding source code and appendices*). Every stack was run locally on 2026-09-07 — FastAPI + Uvicorn backend, React/Vite web, and the Flutter client built for web at a 390 × 844 device viewport. See `report/screenshots/README.md` for the file index and ports.

### G.1  Notebook — Application 1 (Diabetes)

![N1-D — notebook §4: shape / head / info / describe](report/screenshots/NB_D_N1_sec4_inspect.png){width=48%}

![N2-D — notebook §5: missing / duplicate / invalid / imbalance](report/screenshots/NB_D_N2_sec5_quality.png){width=48%}

![§9: BMI outlier view (kept — sensitivity check moves ROC-AUC ≤ 0.003)](report/screenshots/NB_D_01_sec9.png){width=48%}

![N4-D — notebook §12: one raw record → 23-dim feature vector → X shape / dtype](report/screenshots/NB_D_N4_sec12_representation.png){width=48%}

![N6-D — notebook §10: correlation heatmap](report/screenshots/NB_D_03_sec10.png){width=48%}

![N7-D — notebook §18: five-model comparison + winner](report/screenshots/NB_D_N7_sec18_comparison.png){width=48%}

### G.2  Notebook — Application 2 (House price)

![N1-H — notebook §4: shape / head / info / describe](report/screenshots/NB_H_N1_sec4_inspect.png){width=48%}

![N2-H — notebook §5: missing / invalid / skew table](report/screenshots/NB_H_N2_sec5_quality.png){width=48%}

![§9: price / area outlier view (impossible rows dropped)](report/screenshots/NB_H_01_sec9.png){width=48%}

![N4-H — notebook §12: one raw listing → 92-dim feature row → X / y shape](report/screenshots/NB_H_N4_sec12_representation.png){width=48%}

![N5-H — §10.1: Price distribution (raw vs log1p)](report/screenshots/NB_H_02_sec10.1.png){width=48%}

![N5-H — §10.1: Area distribution](report/screenshots/NB_H_03_sec10.1.png){width=48%}

![N5-H — §10.1: price-per-m² distribution](report/screenshots/NB_H_04_sec10.1.png){width=48%}

![N5-H — §10.1: log-target QQ / normality](report/screenshots/NB_H_05_sec10.1.png){width=48%}

![N5-H — §10.1: numeric-feature distributions](report/screenshots/NB_H_06_sec10.1.png){width=48%}

![N6-H — §10.2: |r| with log Price](report/screenshots/NB_H_08_sec10.2.png){width=48%}

![N6-H — §10.2: categorical η² with log Price](report/screenshots/NB_H_09_sec10.2.png){width=48%}

![N6-H — §10.2: Price by Province](report/screenshots/NB_H_10_sec10.2.png){width=48%}

![N6-H — §10.2: Price by Property Type](report/screenshots/NB_H_11_sec10.2.png){width=48%}

![N6-H — §10.2: Area vs Price scatter](report/screenshots/NB_H_12_sec10.2.png){width=48%}

![N6-H — §10.2: Bathrooms / Bedrooms vs Price](report/screenshots/NB_H_13_sec10.2.png){width=48%}

![§10.3: missingness by property type (justifies *_missing flags)](report/screenshots/NB_H_14_sec10.3.png){width=48%}

![§10.3: skew before / after log1p](report/screenshots/NB_H_15_sec10.3.png){width=48%}

![§10.3: QQ-plot of log1p(Price)](report/screenshots/NB_H_16_sec10.3.png){width=48%}

![§10.3: supporting view](report/screenshots/NB_H_17_sec10.3.png){width=48%}

![N7-H — notebook §18: five-model regression comparison + winner](report/screenshots/NB_H_N7_sec18_comparison.png){width=48%}

### G.3  Notebook — Application 3 (Customer behaviour)

![N1-C — notebook §4: shape / head / info / describe](report/screenshots/NB_C_N1_sec4_inspect.png){width=48%}

![N2-C — notebook §5: blank-target / duplicate / imbalance table](report/screenshots/NB_C_N2_sec5_quality.png){width=48%}

![§9: numeric outlier view (kept; log1p handles the skew)](report/screenshots/NB_C_01_sec9.png){width=48%}

![N4-C — notebook §12: raw review → tabular row → shapes + the B=1,T=40,d=16 embedding demo](report/screenshots/NB_C_N4_sec12_representation.png){width=48%}

![N6-C — notebook §10: topic-bucket recommend rates + mutual information](report/screenshots/NB_C_N6_sec10_topics_mi.png){width=48%}
...
![N7-C — notebook §18: representation ladder + 8-model table](report/screenshots/NB_C_N7_sec18_comparison.png){width=48%}

![N9-C — notebook §20: false-negative / false-positive feature comparison](report/screenshots/NB_C_N9_sec20_error_analysis.png){width=48%}

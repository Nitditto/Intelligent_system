...
### 4.3 Tìm hiểu và chất lượng dữ liệu (notebook Mục 4-9)
...
### 4.4 Làm sạch dữ liệu (notebook Mục 13)
...
### 4.5 Biểu diễn dữ liệu (notebook Mục 12)
...
### 4.6 Phân tích khám phá dữ liệu (notebook Mục 10)
...
### 4.7 Phát triển mô hình (notebook Mục 14-17)
...
### 4.8 Đánh giá và so sánh mô hình (notebook Mục 18-19)
...
### 4.10 Lưu trữ và triển khai (notebook Mục 22-23)
...
### 5.3 Tìm hiểu và làm sạch dữ liệu (notebook Mục 4-9, 13)
...
### 5.5 Phân tích khám phá dữ liệu (notebook Mục 10)
...
### 5.6 Mô hình hồi quy và đánh giá (notebook Mục 16-19)
...
### 5.7 Chọn mô hình, lưu trữ và triển khai (notebook Mục 21-23)
...
### 6.3 Biểu diễn khách hàng (notebook Mục 12)
...
### 6.4 Làm sạch dữ liệu (notebook Mục 13)
...
### 6.5 Khám phá sở thích / EDA (notebook Mục 10)
...
### 6.6 Rò rỉ dữ liệu (yêu cầu của đề bài; notebook Mục 14a)
...
### 6.7 Phát triển mô hình (notebook Mục 16-18)
...
### 6.8 Đánh giá và phân tích lỗi (notebook Mục 19-20)
...
### 6.10 Lưu trữ và triển khai (notebook Mục 22-23)
...
## Phụ lục D - Báo cáo Ứng dụng Web (Phụ lục D của đề bài)
...
## Phụ lục E - Báo cáo Ứng dụng Mobile (Phụ lục E của đề bài)
